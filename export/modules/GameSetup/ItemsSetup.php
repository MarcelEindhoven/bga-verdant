...
class ItemsSetup {
    ...
    public function setDeck($deck) : ItemsSetup {
        $this->deck = $deck;
        return $this;
    }
    ...
    public function setup() {
        ...
        for ($i = 0; $i < CardsSetup::MARKET_WIDTH; $i++) {
            $this->deck->pickCardForLocation(\NieuwenhovenGames\BGA\FrameworkInterfaces\Deck::STANDARD_DECK, CardsSetup::MARKET_LOCATION, $i);
        }
    }
    /**
